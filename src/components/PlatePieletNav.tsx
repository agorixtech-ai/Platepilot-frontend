    ...
    mega: [
      {
        ...
        href: "/product",
        links: [
          { label: "Command Center", href: "/product/dashboard", icon: LayoutDashboard },
          { label: "Inventory & Food Cost", href: "/product/food-cost-analysis", icon: PieChart },
          { label: "Menu Engineering", href: "/product/menu-performance", icon: UtensilsCrossed },
          { label: "Waste Intelligence", href: "/product/waste-intelligence", icon: Trash2 },
          {
      ...
      },
      {
        ...
        links: [
          ...
          { label: "Inventory", href: "/product/inventory-intelligence", icon: Boxes },
